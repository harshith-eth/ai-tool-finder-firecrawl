    ...
    <div className={cn("w-full h-full bg-black", className)}>
      ...
      {showContent && (
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
          ...
          >
            <h1 className="text-6xl md:text-8xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70 drop-shadow-sm">
              {title || ''}
            </h1>
            <p className="text-xl md:text-2xl font-medium bg-clip-text text-transparent bg-gradient-to-b from-white/90 to-white/50 flex items-center justify-center">
              {subtitle || ''}
            </p>
          </motion.div>
        </div>
